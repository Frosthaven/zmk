...
#define ZMK_SPLIT_BT_CHAR_CENTRAL_BATTERY_STATE_UUID ZMK_BT_SPLIT_UUID(0x00000007)
#define ZMK_SPLIT_BT_CHAR_SMART_IDLE_STATE_UUID ZMK_BT_SPLIT_UUID(0x00000008)
#define ZMK_SPLIT_BT_CHAR_CENTRAL_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000009)
